 ...
 */
    ...
    public:
        ...
        /// Return the parent button of the popup
        PopupButton* parent_button() { return m_parent_button; }
        /// Return the parent button of the popup
        const PopupButton* parent_button() const { return m_parent_button; }
    ...
    protected:
        // make these thwo protected in order to force the user to access them from the parent popupButton only.
